...
const String TXT_FORECAST_VALUES  = "3-Tages Vorhersage Werte";
const String TXT_CONDITIONS       = "Gegebenheiten";
...
const String TXT_PRESSURE_STEADY  = "Gleichbleibend";
...
const String TXT_PRECIPITATION_SOON = "Niederschlag";
...
//Wind
const String TXT_WIND_SPEED_DIRECTION = "Windgeschwindigkeit/Richtung";
...
//Day of the week
const char* weekday_D[] = { "Son", "Mon", "Die", "Mit", "Don", "Fre", "Sam" };

//Month
const char* month_M[] = { "Jan", "Feb", "Mae", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dez" };
