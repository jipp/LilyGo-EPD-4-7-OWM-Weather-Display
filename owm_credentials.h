...
const char* ssid     = "wobilix";
const char* password = "Eins2Drei4";

// Use your own API key by signing up for a free developer account at https://openweathermap.org/
String apikey       = "58d310da332a79d5409a9d20900a63e1";                      // See: https://openweathermap.org/
...
String City             = "Aachen";                          // Your home city See: http://bulk.openweathermap.org/sample/
String Latitude         = "50.7753455";                         // Latitude of your location in decimal degrees
String Longitude        = "6.0838868";                         // Longitude of your location in decimal degrees
...
const char* ntpServer   = "fritz.box";             // Or, choose a time server close to you, but in most cases it's best to use pool.ntp.org to find an NTP server
